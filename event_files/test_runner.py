...
test_cases = [
    ("1input1.txt", "1output1.txt", 4),
    ("1input2.txt", "1output2.txt", 4),
    ("1input3.txt", "1output3.txt", 4),
    ("1input4.txt", "1output4.txt", 4),
    ("1input5.txt", "1output5.txt", 4),
    ("1input6.txt", "1output6.txt", 4),
]
